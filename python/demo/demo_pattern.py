...
def demo_pattern(*args):
    ...
    middle.material.pattern.transform = Transform().rotation_x(math.pi/2).scaling(0.2,0.2,0.2)
    ...
    right.material.pattern.transform = Transform().rotation_z(math.pi/2).scaling(2,0.5,1)
    ...
    left.material.pattern.transform = Transform().rotation_y(math.pi/6).translation(2,0.5,1)
