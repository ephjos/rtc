...
class Matrix:
    ...
    def __eq__(self, other):
        ...
        return req(self.a, other.a) and \
            req(self.b, other.b) and \
            req(self.c, other.c) and \
            req(self.d, other.d) and \
            req(self.e, other.e) and \
            req(self.f, other.f) and \
            req(self.g, other.g) and \
            req(self.h, other.h) and \
            req(self.i, other.i) and \
            req(self.j, other.j) and \
            req(self.k, other.k) and \
            req(self.l, other.l) and \
            req(self.m, other.m) and \
            req(self.n, other.n) and \
            req(self.o, other.o) and \
            req(self.p, other.p)
    ...
    def __matmul_matrix__(self, other) -> "Matrix":
        ...
        return Matrix(aa*ba+ab*be+ac*bi+ad*bm,
